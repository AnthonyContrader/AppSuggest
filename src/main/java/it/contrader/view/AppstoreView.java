 ...
 */
public class AppstoreView extends AbstractView {
	...
	public void showResults(Request request) {
		if (request != null) {
			System.out.println("\n------------------- Gestione Apps ----------------\n");
			System.out.println("ID\tNome\tCategoria");
			System.out.println("----------------------------------------------------\n");
			
			@SuppressWarnings("unchecked")
			List<AppDTO> apps = (List<AppDTO>) request.get("apps");
			//System.out.println(request.get("app"));
			for (AppDTO u: apps)
